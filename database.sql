...
CREATE TABLE locations (
    ...
    name TEXT NOT NULL,
    type VARCHAR(15) NOT NULL CHECK (type IN ('manufacturer', 'warehouse', 'retailer', 'custom')),
...
-- NOTES
-- =====================================================
-- To use, connect to PostgreSQL and run: psql -U user -d wayalink -f database.sql
-- =====================================================
