...
import { Package, Truck, Warehouse, MapPin, User, Clock, TrendingUp, AlertCircle, RefreshCw } from "lucide-react"
...
export default function LogisticsDashboard() {
  ...
  const handleRefresh = async () => {
    ...
    await Promise.all([mutateShipments(), mutateFleet(), mutateLocations(), mutateRoutes(), mutateUsers()])
